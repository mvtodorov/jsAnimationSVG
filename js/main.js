	...
	*/
	...
	function clearStage(){
		...
		clearTl
			...
			.set($Marto, {autoAlpha: 1, x: '1400%', scale: 2.5, transformOrigin: 'bottom center'})
	...
	function getIntroTl(){
		...
		introTL
			.set($h1, {y: '-=40px'})
			.to($Marto, 0.8, {x: '1000%', ease: Power4.easeInOut})
			...
			.add('zoom-out')
			.to($Marto, 1, {x: '0%', scale: 1, ease: Power4.easeInOut}, 'zoom-out+=1')
